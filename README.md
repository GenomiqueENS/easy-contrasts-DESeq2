...
![Version 2.3.1](https://img.shields.io/badge/Version-V2.3.1-green4)
...
nestedModel       |  NULL                          | boolean |  Whether to perform a test of nested models (NULL: automatic determination based on the DESeq2 model)
sizeFactorType    |  "ratio"                       | string  |  Size factor type
fitType           |  "parametric"                  | string  |  Fit type
statisticTest     |  "Wald"                        | string  |  Statistic test
weightContrast    |  FALSE                         | boolean |  Whether to weight the contrast vector by the number of samples or not*
padjLimit         |  0.05                          | numerical |  Adjusted p-value threshold to consider a gene as differentially expressed
log2FCLimit       |  2                             | numerical |  Absolute log2 fold-change threshold to consider a gene as differentially expressed
prefix            |  "./deseq2_"                   | string  |  Prefix to save the output TSV files
